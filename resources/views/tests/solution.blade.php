            ...
            <div class="bg-gray-800 rounded-lg p-6 shadow-lg">
                ...
                @if($question->explanation)
                    <div class="mt-4 p-4 bg-gray-700 rounded-lg">
                        <h4 class="font-semibold text-gray-100">Izoh:</h4>
